...
impl<'js> JsClass<'js> for DOMException {
    ...
    type Mutable = rsquickjs::class::Writable;
    fn prototype(ctx: &Ctx<'js>) -> rsquickjs::Result<Option<Object<'js>>> {
        use rsquickjs::class::impl_::{MethodImpl, MethodImplementor};
    ...
    fn constructor(ctx: &Ctx<'js>) -> Result<Option<Constructor<'js>>> {
        use rsquickjs::class::impl_::{ConstructorCreate, ConstructorCreator};
...
impl<'js> IntoJs<'js> for DOMException {
    fn into_js(self, ctx: &rsquickjs::Ctx<'js>) -> Result<Value<'js>> {
        let cls = Class::<Self>::instance(ctx.clone(), self)?;
        rsquickjs::IntoJs::into_js(cls, ctx)
    }
}

impl<'js> rsquickjs::FromJs<'js> for DOMException
where
    for<'a> rsquickjs::class::impl_::CloneWrapper<'a, Self>:
        rsquickjs::class::impl_::CloneTrait<Self>,
{
    fn from_js(ctx: &Ctx<'js>, value: Value<'js>) -> Result<Self> {
        use rsquickjs::class::impl_::{CloneTrait, CloneWrapper};
