...
use crate::utils::encoding::{bytes_from_b64, bytes_to_b64_string, Encoder};
use crate::utils::{
    bytes::{
        get_array_bytes, get_coerced_string_bytes, get_start_end_indexes, get_string_bytes,
        ObjectBytes, ERROR_MSG_ARRAY_BUFFER_DETACHED,
    },
...
pub fn atob(ctx: Ctx<'_>, encoded_value: Coerced<String>) -> Result<rsquickjs::String<'_>> {
    ...
    rsquickjs::String::from_str(ctx, &str)
}
